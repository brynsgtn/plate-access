...
const VehicleBlacklistTable = () => {
    ...
    const totalPages = blacklistedVehicles ? Math.ceil(blacklistedVehicles.length / VEHICLES_PER_PAGE) : 1;
    const paginatedVehicles = blacklistedVehicles
        ? blacklistedVehicles.slice((page - 1) * VEHICLES_PER_PAGE, page * VEHICLES_PER_PAGE)
        : [];
