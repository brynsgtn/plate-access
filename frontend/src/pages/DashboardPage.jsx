    ...
    return (
        <>
            <div className='min-h-screen relative overflow-hidden bg-base-100'>
                ...
                {/* Access Controls + Manual Entry Row */}
                <div className='grid lg:grid-cols-2 gap-2 max-w-7xl mx-auto'>
                    ...
                    <div className="max-w-3xl px-4 mb-12">
                        ...
                        <div className=" bg-base-100 rounded-b-xl shadow-lg ">
                            ...
                            <div className="p-5">
                                ...
                                <div className="grid lg:grid-cols-3 gap-6 bg-base-100 rounded-b-xl  p-5">
                                    {/* Entrance Controls */}
                                    <div>
                                        <h3 className="font-semibold mb-3 flex items-center text-base-content">
                                            <Lock className="mr-2 h-4 w-4" />
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-col gap-3">
                                            <button className="btn btn-warning flex items-center justify-center gap-2">
                                                <Unlock className="h-4 w-4" />
                                                Open All
                                            </button>
                                            <button className="btn btn-error flex items-center justify-center gap-2">
                    ...
                    <div className="max-w-4xl px-4 mb-12">
                        ...
                        {/* Manual Plate Entry */}
                        <div className="bg-base-100 p-5 rounded-b-xl shadow mb-6">
                            <label
                                htmlFor="license-plate"
                                className="font-semibold mb-2 flex items-center text-base-content"
                            >
                        ...
                        {/* Add Guest Vehicle */}
                        <div className="bg-base-100 p-5 rounded-b-xl shadow">
                            <h3 className="font-semibold mb-3 flex items-center text-base-content">
                                Add Guest Vehicle
                            </h3>
                            <input
